...
export class AuthService {
  ...
  register(payload: RegisterPayload): Observable<LoginResponse> { return this.authenticate(apiRoutes.auth.register, payload); }
  ...
  private authenticate(url: string, payload: LoginPayload | RegisterPayload): Observable<LoginResponse> {
